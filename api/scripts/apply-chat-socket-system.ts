...
const migrationFile = 'supabase/migrations/20260729100000_chat_socket_system.sql';
...
async function main() {
  ...
  try {
    ...
    console.log('Chat socket system is ready.');
...
main().catch((error) => {
  console.error('Failed to apply chat socket system.');
