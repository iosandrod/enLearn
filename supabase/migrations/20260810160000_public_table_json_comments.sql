...
declare
  v_metadata jsonb := $metadata$
  {
    ...
    "ai_conversations": {"title":"AI 助手会话","description":"记录账套内用户与 AI 助手的页面问答和页面生成会话上下文。"},
    "ai_messages": {"title":"AI 助手消息","description":"保存 AI 助手会话中的用户、助手、系统及工具消息。"},
    ...
    "chat_messages": {"title":"聊天消息","description":"统一保存账套会话中的文本、附件、回复和状态，是聊天内容的核心明细表。"},
    ...
    "users": {"title":"用户资料","description":"扩展认证用户的姓名、联系方式和应用角色，是应用用户的公开资料。"},
