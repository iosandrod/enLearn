...
insert into public.lowcode_pages (
  ...
  '{"schemaVersion":1,"code":"planning_bom_view","route":"/dashboard/planning/bom-view","title":"BOM","pageType":"custom","description":"查看产成品、工艺路线、工序和组件之间的递归结构。","layout":"dashboard","status":"published","keepAlive":true,"dataSources":{"bom":{"key":"bom","label":"BOM 结构","sourceType":"custom","serviceName":"planning","serviceMethod":"getPlanningConsoleData","postData":{"dataset":"bom","filters":{"itemId":"{{ forms.planning_bom_filter.itemId }}"}},"autoLoad":true},"bomFlow":{"key":"bomFlow","label":"选中物料工艺路线图","sourceType":"custom","serviceName":"planning","serviceMethod":"getPlanningConsoleData","postData":{"dataset":"flow","filters":{"operationId":"__none__"},"requiredFilters":["operationId"]},"autoLoad":false},"itemOptions":{"key":"itemOptions","label":"产品与物料选项","sourceType":"custom","serviceName":"planning","serviceMethod":"getPlanningConsoleOptions","postData":{"optionType":"item"},"autoLoad":true}},"eventHandlers":[{"event":"planningBom.nodeSelect","blockId":"planning_bom_tree","disabled":false,"directives":[{"type":"navigate","route":"/dashboard/planning/{{ row.entityType }}/edit?id={{ row.entityId }}&fromPage=planning_bom_view","disabled":false}]},{"event":"planningBom.routeSelect","blockId":"planning_bom_tree","disabled":false,"directives":[{"type":"setSearchFilters","sourceKey":"bomFlow","mode":"replace","values":{"operationId":"{{ event.route.id }}"},"disabled":false}]},{"event":"planningBom.createRoute","blockId":"planning_bom_tree","disabled":false,"directives":[{"type":"navigate","route":"/dashboard/planning/operation/edit?prefill=%7B%22item_id%22%3A%22{{ event.materialId }}%22%2C%22type%22%3A%22routing%22%7D&fromPage=planning_bom_view","disabled":false}]}],"blocks":[{"id":"planning_bom_filter","kind":"searchForm","title":"BOM 筛选","targetSourceKey":"bom","initialValues":{"itemId":""},"schema":{"columns":3,"fields":[{"field":"itemId","label":"产品/物料","component":"vxe-select","optionsSourceKey":"itemOptions","optionProps":{"label":"label","value":"id"},"props":{"clearable":true,"filterable":true,"placeholder":"全部产品与物料"},"events":{"change":[{"type":"refreshDataSources","sourceKeys":["bom"]}]}}],"actions":[{"code":"submit","label":"查询","type":"submit","status":"primary","icon":"ri-search-line"},{"code":"reset","label":"重置","type":"reset","icon":"ri-refresh-line"}]}},{"id":"planning_bom_workspace","kind":"container","columns":2,"columnSpans":[1,1],"gap":12,"blocks":[{"id":"planning_bom_tree","kind":"planningBom","sourceKey":"bom","height":650,"title":"BOM","description":"按产品、工艺路线、工序和组件递归展开。","keyField":"id","titleField":"title","childrenField":"children","columns":[{"field":"title","title":"BOM","minWidth":260,"treeNode":true},{"field":"entityType","title":"类型","width":110},{"field":"quantity","title":"用量","width":100,"align":"right"},{"field":"uom","title":"单位","width":90},{"title":"操作","width":180,"fixed":"right","slots":{"default":"actions"}}],"treeConfig":{"children":"children","expandAll":true,"showIcon":true},"routeActionDirectives":[]},{"id":"planning_bom_flow","kind":"planningFlow","sourceKey":"bomFlow","height":650,"title":"产出工艺路线","description":"选择物料操作中的路线后，在此查看工序模型。","fitViewOnInit":true}]}]}'::jsonb, 1, timezone('utc'::text, now())
)
on conflict (code) do update set
  route = excluded.route,
  title = excluded.title,
