        ...
        "tabs": [
          {
            ...
            "blocks": [
              {
                "id": "system-settings-appearance-form",
                "kind": "form",
                            ...
                            },
                            {
                              ...
                              "props": {
                                "schema": {
                                  "columns": 4,
                                  "fields": [
                                    { "field": "primary", "label": "主色", "component": "lc-color-picker", "props": { "clearable": false } },
                                    { "field": "success", "label": "成功", "component": "lc-color-picker", "props": { "clearable": false } },
                                    { "field": "warning", "label": "警告", "component": "lc-color-picker", "props": { "clearable": false } },
                                    { "field": "danger", "label": "危险", "component": "lc-color-picker", "props": { "clearable": false } },
                                    { "field": "info", "label": "信息", "component": "lc-color-picker", "props": { "clearable": false } },
                                    { "field": "background", "label": "页面背景", "component": "lc-color-picker", "props": { "clearable": false } },
                                    { "field": "surface", "label": "内容表面", "component": "lc-color-picker", "props": { "clearable": false } },
                                    { "field": "text", "label": "正文文字", "component": "lc-color-picker", "props": { "clearable": false } }
                                  ],
                                  "actions": []
                                }
                              }
          ...
          },
          {
            ...
            "blocks": [
              {
                "id": "system-settings-locale-form",
                "kind": "form",
                "sourceKey": "systemSettings",
                "submitSourceKey": "systemSettings",
                "style": {
                        ...
                        "schema": {
                          ...
                          "fields": [
                            ...
                            },
                            {
                              ...
                              "component": "vxe-select",
                              "options": [
                                { "label": "2026-08-04", "value": "YYYY-MM-DD" },
                                { "label": "2026/08/04", "value": "YYYY/MM/DD" },
                                { "label": "04/08/2026", "value": "DD/MM/YYYY" },
                                { "label": "08/04/2026", "value": "MM/DD/YYYY" }
                              ]
                            },
                            {
                              "field": "timeFormat",
          ...
          },
          {
            ...
            "blocks": [
              {
                "id": "system-settings-advanced-form",
                "kind": "form",
                "sourceKey": "systemSettings",
                "submitSourceKey": "systemSettings",
                "style": {
