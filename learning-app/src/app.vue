    ...
    <template v-else>
      <div class="app-header">
        ...
        <div class="app-title-group">
          <span class="app-kicker">ENLEARN COURSE HUB</span>
      ...
      <div class="app-workspace">
        <div v-if="wideLayout" class="desktop-sidebar">
          <div class="sidebar-brand">
            <span class="sidebar-brand-title">课程培训中心</span>
            <span class="sidebar-brand-copy">{{ learningRoleLabel }}移动工作台</span>
          </div>
            ...
            <div class="mobile-menu-heading">
              <div class="mobile-menu-brand">
                ...
                <div class="mobile-menu-brand-copy">
                  <span class="mobile-menu-title">课程培训中心</span>
                  <span class="mobile-menu-subtitle">{{ learningRoleLabel }}移动工作台</span>
                </div>
              </div>
...
const learningRole = ref<'student' | 'teacher'>('student');
...
const pageTitle = computed(() => runtimePageTitle.value || String(route.meta.title ?? '课程培训工作台'));
const learningRoleLabel = computed(() => learningRole.value === 'teacher' ? '教师端 · 教学管理' : '学生端 · 学习中心');
...
onMounted(async () => {
  ...
  learningRole.value = (await readMobileStorage('appRole')) === 'teacher' ? 'teacher' : 'student';
