...
import { VisualEditorPropsType, type VisualEditorProps } from '@/visual-editor/visual-editor.props';
import type {
...
function normalizeFieldValue(field: MaterialPropFormField, value: unknown) {
