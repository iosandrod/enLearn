...
import converter from '~/lowcode/visual-converters/lowcode-button-group';
...
export default {
  ...
  component,
  designer: () =>
    import('~/packages/business-component/lowcode-button-group').then((module) => module.default),
