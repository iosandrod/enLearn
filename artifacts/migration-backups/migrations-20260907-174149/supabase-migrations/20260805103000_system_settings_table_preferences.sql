-- Expand the per-user default table preferences and organize them inside the single settings form.
...
set
  schema = jsonb_set(
    jsonb_set(
      schema,
      '{blocks,2,initialValues,table_config}',
...
$table_config_defaults$::jsonb,
      false
    ),
    '{blocks,2,schema,fields,3}',
$table_config_field$
      {
        "field": "table_config",
        "label": "默认表格参数",
          ...
          "schema": {
            ...
            "fields": [
              ...
              },
              {
                ...
                "options": [
                  {
                    "label": "2026-08-05 14:30:00",
                    "value": "YYYY-MM-DD HH:mm:ss"
                  },
                  {
                    "label": "2026-08-05 14:30",
