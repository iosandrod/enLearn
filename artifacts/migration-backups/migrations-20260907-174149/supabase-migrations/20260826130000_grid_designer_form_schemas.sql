  ...
  (
    ...
    $schema$
    {
      ...
      "fields": [
        ...
        {
          "field": "postDataJson", "label": "请求参数", "component": "lc-sub-form",
          "props": {
            "schema": {
              "columns": 2,
              "fields": [
                ...
                {
                  "field": "orderDirection", "label": "排序方向", "component": "vxe-select",
                ...
                {
                  "field": "responseMode", "label": "响应模式", "component": "vxe-select",
                  "options": [{ "label": "列表", "value": "" }, { "label": "分页对象", "value": "page" }]
                },
                {
                  "field": "clientMode", "label": "客户端模式", "component": "vxe-select",
                  "options": [{ "label": "当前用户", "value": "" }, { "label": "管理员", "value": "admin" }]
                }
              ],
              "layout": [],
              "actions": []
