const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/router-cC9wlkqL.js","assets/router-B1F7VFLw.js","assets/preload-helper-Czpn1I53.js","assets/vue-router-DpOqaoIa.js","assets/vue.runtime.esm-bundler-BUX7uHjG.js","assets/rolldown-runtime-CNC7AqOf.js","assets/useAuth-CiZ123IZ.js","assets/useAuthState-DW3Hbuff.js"])))=>i.map(i=>d[i]);
import{A as e,g as t,mt as n,st as r}from"./vue.runtime.esm-bundler-BUX7uHjG.js";import{t as i}from"./preload-helper-Czpn1I53.js";var a=`---\r
...
\r
`,w=Object.assign({"../../content/blog/complete-setup.mdx":a,"../../content/blog/integration-supacrawler.mdx":o,"../../content/blog/introduction.mdx":s,"../../content/blog/roadmap.mdx":c,"../../content/blog/what-is-hikari.mdx":l,"../../content/blog/why-build-hikari.mdx":u}),T=Object.assign({"../../content/docs/configure/index.mdx":d,"../../content/docs/configure/stripe/index.mdx":f,"../../content/docs/configure/stripe/local.mdx":p,"../../content/docs/configure/stripe/production.mdx":ee,"../../content/docs/configure/supabase/index.mdx":te,"../../content/docs/configure/supabase/local.mdx":m,"../../content/docs/configure/supabase/supabase.mdx":h,"../../content/docs/configure/vercel.mdx":g,"../../content/docs/index.mdx":_,"../../content/docs/quick-start.mdx":v,"../../content/docs/storage/example.mdx":y,"../../content/docs/storage/setting-up.mdx":b,"../../content/docs/test.mdx":x,"../../content/docs/trpc/example.mdx":S,"../../content/docs/trpc/setup.mdx":C});function E(e){return e.replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#039;`)}function D(e){return E(e).replaceAll("`",`&#096;`)}function ne(e){let t=e.match(/^---\r?\n([\s\S]*?)\r?\n---\r?\n?([\s\S]*)$/);return t?{data:t[1].split(/\r?\n/).reduce((e,t)=>{let n=t.indexOf(`:`);if(n===-1)return e;let r=t.slice(0,n).trim();return e[r]=t.slice(n+1).trim().replace(/^["']|["']$/g,``),e},{}),body:t[2].trim()}:{data:{},body:e.trim()}}function re(e){return e.toLowerCase().trim().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)}function ie(e,t){let n=re(e)||`section`,r=t.get(n)??0;return t.set(n,r+1),r===0?n:`${n}-${r+1}`}function O(e){let t=[],n=E(e);return n=n.replace(/`([^`]+)`/g,(e,n)=>{let r=`__INLINE_CODE_${t.length}__`;return t.push(`<code>${n}</code>`),r}),n=n.replace(/\[([^\]]+)\]\(([^)]+)\)/g,(e,t,n)=>`<a href="${D(n)}">${t}</a>`),n=n.replace(/\*\*([^*]+)\*\*/g,`<strong>$1</strong>`).replace(/\*([^*]+)\*/g,`<em>$1</em>`),t.forEach((e,t)=>{n=n.replace(`__INLINE_CODE_${t}__`,e)}),n}function ae(e){let t={};for(let n of e.matchAll(/(\w+)=["']([^"']*)["']/g))t[n[1]]=n[2];return t}function oe(e){let t=[...e.matchAll(/<Card\s+([^>]+?)\/>/g)].map(e=>ae(e[1]));return t.length?[`<div class="docs-card-grid">`,...t.map(e=>{let t=E(e.title??`Open page`),n=e.description?`<span class="docs-card-description">${E(e.description)}</span>`:``;return`<a class="docs-card" href="${D(e.href??`#`)}"><span class="docs-card-title">${t}</span>${n}</a>`}),`</div>`].join(``):``}function se(e){let t=new Map,n=e.replace(/<Cards>([\s\S]*?)<\/Cards>/g,(e,n)=>{let r=`__DOC_CARD_BLOCK_${t.size}__`;return t.set(r,oe(n)),`\n${r}\n`}),r=[],i=[],a=new Map;for(let e of n.split(/\n{2,}/)){let n=e.trim();if(!n)continue;if(t.has(n)){r.push(n);continue}if(n.startsWith("```")){let e=n.replace(/^```[^\n]*\n?/,``).replace(/\n?```$/,``);r.push(`<pre><code>${E(e)}</code></pre>`);continue}let o=n.match(/^(#{1,3})\s+(.+)$/);if(o){let e=o[1].length,t=o[2].trim(),n=ie(t,a);i.push({depth:e,id:n,text:t}),r.push(`<h${e} id="${n}">${O(t)}</h${e}>`);continue}if(/^[-*]\s+/m.test(n)){r.push(`<ul>${n.split(/\r?\n/).map(e=>`<li>${O(e.replace(/^[-*]\s+/,``))}</li>`).join(``)}</ul>`);continue}r.push(`<p>${O(n.replace(/\r?\n/g,` `))}</p>`)}let o=r.join(`
`);for(let[e,n]of t.entries())o=o.replaceAll(e,n);return{html:o,toc:i}}function k(e,t){let[,n=``]=e.replace(/\\/g,`/`).split(`/content/${t}/`),r=n.replace(/\.mdx$/,``).split(`/`);return r.at(-1)===`index`&&r.pop(),r.join(`/`)}function A(e){let t=e.replace(/```[\s\S]*?```/g,``);for(let e of t.split(/\r?\n/)){let t=e.trim();if(!(!t||t.startsWith(`#`)||t.startsWith(`<`)||t.startsWith(`- `)||/^\d+\.\s/.test(t)))return t.replace(/\[([^\]]+)\]\(([^)]+)\)/g,`$1`).replace(/[*`]/g,``).slice(0,180)}return``}function j(e,t,n,r){let{data:i,body:a}=ne(t),o=k(e,n),s=se(a),c=i.title??o.split(`/`).at(-1)??`Untitled`,l=i.description??A(a);return{slug:o,href:o?`${r}/${o}`:r,title:c,description:l,date:i.date,author:i.author,excerpt:l,bodyHtml:s.html,toc:s.toc}}function M(e){let t=Object.entries(w).map(([e,t])=>{let{bodyHtml:n,toc:r,...i}=j(e,t,`blog`,`/blog`);return i}).sort((e,t)=>new Date(t.date??t.slug).getTime()-new Date(e.date??e.slug).getTime());return typeof e==`number`?t.slice(0,e):t}function N(e){let t=Object.entries(w).find(([t])=>k(t,`blog`)===e);if(!t)throw Error(`Blog post not found`);return j(t[0],t[1],`blog`,`/blog`)}function P(e){let t=Object.entries(T).find(([t])=>k(t,`docs`)===e);if(!t)throw Error(`Doc page not found`);return j(t[0],t[1],`docs`,`/docs`)}async function F(e){let t=new URL(e,window.location.origin);if(t.pathname===`/api/content/blog`){let e=Number(t.searchParams.get(`limit`));return M(Number.isFinite(e)&&e>0?e:void 0)}if(t.pathname.startsWith(`/api/content/blog/`))return N(decodeURIComponent(t.pathname.replace(`/api/content/blog/`,``)));if(t.pathname===`/api/content/docs`)return P(``);if(t.pathname.startsWith(`/api/content/docs/`))return P(decodeURIComponent(t.pathname.replace(`/api/content/docs/`,``)));throw Error(`Unsupported content URL: ${e}`)}e(),r();var I=new Map,L=`enlearn_access_token`,R=`enlearn_refresh_token`,z=`enlearn_active_account_id`,B=null;function V(){return`http://localhost:3002/api`.replace(/\/+$/,``)}function H(e){return e.replace(/^\/api/,``)}function U(){return localStorage.getItem(L)||``}function W(){return localStorage.getItem(R)||``}function ce(){return localStorage.getItem(z)||``}function G(e){let t=e?.session;t?.access_token&&(localStorage.setItem(L,t.access_token),t.refresh_token&&localStorage.setItem(R,t.refresh_token))}function K(){localStorage.removeItem(L),localStorage.removeItem(R),localStorage.removeItem(z)}function q(e,t){if(!t)return e;let n=new URL(e,window.location.origin);for(let[e,r]of Object.entries(t))r!=null&&n.searchParams.set(e,String(r));return n.pathname+n.search+n.hash}function J(e){if(!e)return null;try{return JSON.parse(e)}catch{return{message:e}}}function le(e,t){if(typeof e==`string`)return e;if(!e||typeof e!=`object`)return t;let n=e,r=Array.isArray(n.message)?n.message.filter(Boolean).join(`, `):n.message;return String(r??n.statusMessage??n.error??t)}function Y(e,t){let n=t.toLowerCase();return e===401||n.includes(`jwt expired`)||n.includes(`invalid jwt`)||n.includes(`invalid token`)||n.includes(`authentication required`)}function ue(e){return!e.startsWith(`/auth/refresh`)&&!e.startsWith(`/auth/signin`)&&!e.startsWith(`/auth/signup`)&&!e.startsWith(`/auth/account-options`)}function de(e,t,n){if(t)return t;if(n!==void 0&&(e.startsWith(`/auth/signin`)||e.startsWith(`/auth/signup`)||e.startsWith(`/auth/session`)||e.startsWith(`/auth/signout`)||e.startsWith(`/auth/refresh`)||e.startsWith(`/service`)))return`POST`}function fe(){window.location.pathname!==`/signin`&&$(`/signin`).catch(()=>{window.location.href=`/signin`})}function pe(){let e=!!(U()||W());K(),(e||window.location.pathname.startsWith(`/dashboard`))&&fe()}async function me(){let e=W();return e?(B||=(async()=>{let t=await fetch(`${V()}/auth/refresh`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({refreshToken:e})}),n=J(await t.text());return t.ok?(G(n),!!n?.session?.access_token):!1})().catch(()=>!1).finally(()=>{B=null}),B):!1}async function X(e,t={},n=!1){let r=H(q(e,t.query)),{query:i,body:a,...o}=t,s=new Headers(t.headers),c=U(),l=ce();c&&!s.has(`Authorization`)&&s.set(`Authorization`,`Bearer ${c}`),l&&!s.has(`X-Account-Id`)&&!r.startsWith(`/auth/select-account`)&&!r.startsWith(`/auth/account-options`)&&s.set(`X-Account-Id`,l),a!==void 0&&!(a instanceof FormData)&&s.set(`Content-Type`,s.get(`Content-Type`)||`application/json`);let u=await fetch(`${V()}${r}`,{...o,method:de(r,o.method,a),headers:s,body:a===void 0||a instanceof FormData?a:JSON.stringify(a)}),d=J(await u.text());if(!u.ok){let i=le(d,u.statusText);if(!n&&Y(u.status,i)&&ue(r)&&await me())return X(e,t,!0);throw Y(u.status,i)&&pe(),Q({statusCode:u.status,statusMessage:i})}return(r.startsWith(`/auth/signin`)||r.startsWith(`/auth/signup`)||r.startsWith(`/auth/session`))&&G(d),r.startsWith(`/auth/signout`)&&K(),d}async function he(e,t={}){let n=H(e),r=String(t.method??`GET`).toUpperCase(),i=n.match(/^\/posts\/([^/]+)$/)?.[1];return r===`GET`&&n===`/posts`?X(`/api/service`,{method:`POST`,body:{serviceName:`posts`,serviceMethod:`listItems`,postData:{tableName:`posts`}}}):r===`POST`&&n===`/posts`?X(`/api/service`,{method:`POST`,body:{serviceName:`posts`,serviceMethod:`createItem`,postData:{resource:`posts`,...t.body??{}}}}):r===`PUT`&&i?X(`/api/service`,{method:`POST`,body:{serviceName:`posts`,serviceMethod:`updateItem`,postData:{resource:`posts`,id:i,...t.body}}}):r===`DELETE`&&i?X(`/api/service`,{method:`POST`,body:{serviceName:`posts`,serviceMethod:`deleteItem`,postData:{resource:`posts`,id:i}}}):X(e,t)}function Z(e,t){return I.has(e)||I.set(e,n(t())),I.get(e)}function Q(e){let t=Error(e.statusMessage??e.message??`Application error`);return t.statusCode=e.statusCode,t.statusMessage=e.statusMessage,t}async function $(e){let{router:t}=await i(async()=>{let{router:e}=await import(`./router-cC9wlkqL.js`);return{router:e}},__vite__mapDeps([0,1,2,3,4,5,6,7]));return t.push(e)}function ge(e){let n=e.title,r=e.description,i=typeof n==`function`?t(n).value:n,a=typeof r==`function`?t(r).value:r;if(i&&(document.title=String(i)),a){let e=document.querySelector(`meta[name="description"]`);e||(e=document.createElement(`meta`),e.name=`description`,document.head.appendChild(e)),e.content=String(a)}}async function _e(e,t,r={}){let i=n(r.default?r.default():null),a=n(null);try{i.value=await t()}catch(e){a.value=e}return{data:i,error:a}}async function ve(e,t={}){let n=q(e,t.query);return n.startsWith(`/api/content/`)?F(n):n===`/api/auth/socket-token`?{token:U(),socketBaseUrl:`http://localhost:3002`}:n.startsWith(`/api/posts`)?he(n,t):X(n,t)}export{ge as a,_e as i,Q as n,Z as o,$ as r,ve as t};