...
let contextMenuController: NonNullable<VxeUILike['contextMenu']> | null = null
let activeContextMenuTable: any = null
...
export function showCellAreaContextMenu ($table: any, evnt: MouseEvent) {
  ...
  contextMenuController.open({
    ...
    events: {
      optionClick ({ option, $event }: { option: { code?: string }, $event: Event }) {
