...
const overlayRefsMap = new WeakMap();
...
function createAreaOverlayRefs(areaEl) {
    return {
...
function queryAreaOverlayRefs($table) {
...
function getAreaOverlayRefs($table, force = false) {
    if (force) {
...
export function hideCellAreaOverlays($table) {
...
function getCellAreaRefs($table, cell) {
...
function applyCellAreaPosition(refs, position) {
...
function appendCellItemPosition(refs, position) {
    if (!refs.multiAreaEl) {
        return false;
    }
...
export function showCellArea($table, area, startCell, endCell = startCell) {
...
export function showInactiveCellArea($table, startCell, endCell = startCell) {
    const refs = getCellAreaRefs($table, startCell);
    const areaEl = refs?.areaEl;
    if (!refs || !areaEl) {
        return false;
...
export function showCellAreaByAnchorOffset($table, area, anchorCell, position) {
...
export function showInactiveCellAreaByAnchorOffset($table, anchorCell, position) {
    const refs = getCellAreaRefs($table, anchorCell);
    const areaEl = refs?.areaEl;
    if (!refs || !areaEl) {
        return false;
...
export function showSingleCellArea($table, area, cell) {
