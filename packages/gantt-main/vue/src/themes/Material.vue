...
defineOptions({ name: "GanttThemesMaterial" });
...
<template>
	<div v-if="$slots.default" class="wx-material-theme">
		<slot />
	</div>
	<span v-else class="wx-material-theme wx-material-theme-provider"></span>
</template>
...
:global(.wx-material-theme) {
	...
	--wx-gantt-bar-shadow: 0 1px 2px rgba(44, 47, 60, 0.06),
	...
	--wx-grid-header-shadow: 0 3px 5px rgba(0, 0, 0, 0.1),
	...
	--wx-timescale-shadow: 0 3px 5px rgba(0, 0, 0, 0.1),
		0 1px 2px rgba(0, 0, 0, 0.1);
