...
export type TriggerWorkflowTaskType = 'frontendCommand' | 'backendCommand' | 'storedProcedure' | 'registeredTask';
export type TriggerWorkflowTaskFailureStrategy = 'failWorkflow' | 'continue' | 'useDefaultOutput';
