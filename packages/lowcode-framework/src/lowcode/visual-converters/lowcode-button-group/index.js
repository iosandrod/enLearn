import { isPlainRecord, normalizeRows, readBoolean, readDimension, readJsonArray, readString, readVisualBlockProps, toBlockId, } from '../helpers';
...
function normalizeButton(row, indexPath) {
