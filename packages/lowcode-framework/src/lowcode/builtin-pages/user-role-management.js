...
function createUserGridConfig(columns, height) {
    return {
        border: true,
        stripe: true,
        showOverflow: true,
...
export const userRoleManagementSchema = {
    schemaVersion: 1,
...
export function createBuiltinLowCodePageRecord(schema) {
...
export const userRoleManagementPage = createBuiltinLowCodePageRecord(userRoleManagementSchema);
