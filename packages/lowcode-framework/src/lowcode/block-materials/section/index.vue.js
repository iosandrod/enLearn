...
__VLS_asFunctionalElement1(__VLS_intrinsics.section, __VLS_intrinsics.section)({
    ...{ class: (['lc-node-section', { 'content-panel': __VLS_ctx.block.panel !== false }]) },
});
/** @type {__VLS_StyleScopedClasses['lc-node-section']} */ ;
...
var __VLS_4;
// @ts-ignore
[block, block, block, block, block, block, block, block, resolvedData, formModels, searchFilters, loadingBlockId, loadingGridId, emit, emit, emit, emit, emit, emit, emit, emit,];
