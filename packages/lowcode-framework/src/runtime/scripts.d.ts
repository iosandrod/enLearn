...
export type LowCodeScriptCapabilityName = 'action.execute' | 'api.invoke' | 'dialog.confirmLowCodePage' | 'dialog.open' | 'event.emit' | 'form.patch' | 'form.replace' | 'grid.setRows' | 'http.execute' | 'pageFunction.execute' | 'message.error' | 'message.info' | 'message.success' | 'message.warning' | 'node.runtime' | 'page.refresh' | 'router.push' | 'search.patch' | 'search.replace' | 'source.refresh' | 'source.refreshAll' | 'source.set' | 'form.prepare' | 'form.submit' | 'message.show' | 'page.exit' | 'page.navigateToEdit' | 'page.print' | 'page.setMode' | 'records.delete' | 'records.update' | 'service.invoke';
 ...
 */
export declare function createLowCodeBrowserScriptExecutor(): LowCodeScriptExecutor;
