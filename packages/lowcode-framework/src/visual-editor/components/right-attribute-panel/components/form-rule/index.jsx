...
import { ElCard, ElTooltip } from '../../../common/designer-ui';
import { QuestionFilled } from '../../../common/remix-icons';
    ...
    setup() {
        ...
        <ElCard shadow={'always'} bodyStyle={{ padding: '0' }} class={'mb-20px'}>
          {{
                header: () => (<div class="flex justify-between">
                <span>设置选项关联规则</span>
                <ElTooltip content="当前面题目选择某些选项时才出现此题的某些选项 " placement="bottom-end">
                  <span class="lc-remix-icon-slot">
                    <QuestionFilled />
                  </span>
                </ElTooltip>
