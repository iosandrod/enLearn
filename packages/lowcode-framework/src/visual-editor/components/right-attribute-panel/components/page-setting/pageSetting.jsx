...
import { ElForm, ElFormItem, ElInput, ElUpload, ElColorPicker, ElSwitch } from '../../../common/designer-ui';
import { Plus } from '../../../common/remix-icons';
    ...
    setup() {
        ...
        <ElForm>
          ...
          <ElUpload action={''} beforeUpload={beforeUpload} class={styles.upload}>
            {pageConfig.bgImage ? (<img src={pageConfig.bgImage}/>) : (<span class="uploader-icon">
                <Plus />
              </span>)}
          </ElUpload>
        </ElForm>
