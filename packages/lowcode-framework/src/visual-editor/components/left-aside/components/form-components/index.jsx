...
export default defineComponent({
    ...
    setup() {
        ...
        return () => (<DraggableView class={styles.listGroup} sort={false} forceFallback={false} list={formComponents.value} group={{ name: 'components', pull: 'clone', put: false }} clone={cloneComponent} item-key="_vid">
        {{
