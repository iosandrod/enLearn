...
for (const [child] of __VLS_vFor((__VLS_ctx.blocks))) {
    let __VLS_0;
    ...
    var __VLS_4;
    // @ts-ignore
    [blocks, resolvedData, formModels, searchFilters, loadingBlockId, loadingGridId, emit, emit, emit, emit, emit, emit, emit, emit,];
}
// @ts-ignore
[];
