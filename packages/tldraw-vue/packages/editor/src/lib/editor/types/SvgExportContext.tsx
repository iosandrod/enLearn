...
import type { SvgExportNode } from './SvgExportNode'

export type SvgExportRenderable = ReactElement | SvgExportNode

/** @public */
export interface SvgExportDef {
	key: string
	getElement(): Promise<SvgExportRenderable | null> | SvgExportRenderable | null
}
